...
2. HANDS: ALL human figures must have smooth, featureless white mannequin hands made of MATTE WHITE PLASTIC/RESIN - identical material to the head. No fingernails, no skin creases, no veins. Clean articulated mannequin hands like department store display mannequins.
3. MATERIAL CONSISTENCY: Head, neck, and hands must all be the same smooth MATTE WHITE PLASTIC/RESIN material throughout. No skin tones, no flesh texture, no grey - pure white mannequin plastic.
...
5. APPLIES TO ALL: This applies to EVERY human - main characters AND background people, crowds, extras. Differentiate characters ONLY by clothing, body language, and positioning.`,
            character: `[FACELESS MANNEQUIN CHARACTER]: This character has a smooth white plastic mannequin head with ZERO facial features - no eyes, no nose, no mouth, no ears. Head is a perfect smooth white oval. Hands are smooth, featureless white mannequin hands made of the same MATTE WHITE PLASTIC/RESIN as the head. Character MUST be fully clothed including SHOES. Identify them by their detailed clothing, posture, and accessories only.`,
